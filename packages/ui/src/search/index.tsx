  ...
  return (
    <div
      className={cn(
        ...
        '[&_.DocSearch-Button]:ui-transition-colors',
        'hover:[&_.DocSearch-Button]:ui-shadow-none',
        variant === 'home' && 'hover:[&_.DocSearch-Button]:ui-border-white',
        variant === 'system' && 'hover:[&_.DocSearch-Button]:ui-border-zinc-400 dark:hover:[&_.DocSearch-Button]:ui-border-slate-500',
