...
import { updateFile, updateSnippet } from './append-package-tags-in-snippets';

describe('updateFile', () => {
  test('matches block shell snippets and appropriate inline snippets', () => {
    expect(
      updateFile(
        `
...
describe('updateSnippet', () => {
  test('updates desired inline snippets', () => {
  ...
  test('does not update undesired inline snippets', () => {
    ...
    expect(updateSnippet('storybook upgrade', false, false)).toMatchInlineSnapshot(
      `"storybook upgrade"`
    );
    expect(updateSnippet('storybook upgrade', false, true)).toMatchInlineSnapshot(
      `"storybook upgrade"`
    );
  });
  test('updates desired block snippets', () => {
