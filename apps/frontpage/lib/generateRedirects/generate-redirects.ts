...
// eslint-disable-next-line no-unused-vars, @typescript-eslint/no-unused-vars -- temp
export function generateRedirects({ rawRedirects }: { rawRedirects: string }) { return [] }