...
export function GenerateUIAnimation() {
  return (
    ...
    >
      <StaggeredGrid />
      <div className="relative flex items-center justify-center bg-[url(/ai/agent-output-bg.svg)] bg-cover bg-center bg-no-repeat px-12 pb-12 pt-16 md:px-12 md:py-20">
        <div className="absolute left-4 top-4 text-[11px] font-extrabold uppercase leading-4 tracking-[0.35em] text-white/70 sm:left-8 sm:top-8">
          Agent Output
        </div>
        <MotionImage
          ...
          alt="Agent combines components into an app"
          width={451}
          height={343}
        />
      </div>
